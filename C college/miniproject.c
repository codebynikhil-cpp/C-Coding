...
int main() {
    ...
    struct Flight flight1 = {1, "Ranchi", 50, 0};
    struct Flight flight2 = {2, "Mumbai", 40, 0};
    struct Flight flight3 = {3, "Goa", 30, 0};
...
void displayFlights(struct BookingSystem *bookingSystem) {
    ...
    for (int i = 0; i < bookingSystem->numFlights; i++) {
        printf("Flight %d: Destination: %s, Capacity: %d, Booked Seats: %d\n",
